            ...
            <table class="min-w-full bg-white">
                <thead class="bg-gray-800 text-white">
                    <tr>
                        ...
                        <th class="w-1/5 text-left py-3 px-4 uppercase font-semibold text-sm text-center">{{__('Nombre del producto')}}</th>
                        <th class="w-1/2 text-left py-3 px-4 uppercase font-semibold text-sm text-center">{{__('Descripción')}}</th>
                        <th class="w-30 text-left py-3 px-4 uppercase font-semibold text-sm text-center">{{__('Precio')}}</th>
                        <th class="w-50 text-left py-3 px-4 uppercase font-semibold text-sm text-center">{{__('Categoria')}}</th>
