...
<div class="w-5/6 mx-auto">
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{ $route }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nombre" name="nombre" type="text" value="{{old('nombre') ?? $hdd->nombre}}">            
            @error('nombre')
        ...
        <div class="mb-3">
            ...
            <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="descripcion" name="descripcion" type="text">{{old('descripcion') ?? $hdd->descripcion}}</textarea>             
            @error('descripcion')
        ...
        <div class="mb-3">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="precio" name="precio" type="number" value="{{old('precio') ?? $hdd->precio}}">                      
            @error('precio')
                <div class="mt-2 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">                        
                    <span class="block sm:inline">{{ $message }}</span>
                    <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
        ...
        <div class="flex items-center justify-center">
            ...
            <a href="{{route('hdds.index')}}" class="bg-red-500 hover:bg-red-400 text-white font-bold mx-1 py-2 px-4 border-b-4 border-red-700 hover:border-red-500 rounded" type="reset">
