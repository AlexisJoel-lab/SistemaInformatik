...
<head>
  ...
  <title>{{config('app.name', 'Informattik')}}</title>
	...
	<div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
		...
		<div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
			<ul class="list-reset lg:flex justify-end flex-1 items-center">
				...
				<li class="mr-3">
					<a id="nav-link2" class="nav-link1 inline-block text-gray-300 no-underline hover:text-white hover:text-underline py-2 px-4" href="{{route('proforma')}}">PROFORMA</a>
				</li>
            </ul>
            @if (Route::has('login'))
